...
public class A_Break {
	...
	public void method3() {
		...
		// 출력하는 프로그램을 작성하시오.
		// 단, 사용자가 양수를 입력하는 경우 반복을 종료 시키세요.

		/*
		 * while(true) { System.out.print("양수 :"); int num = sc.nextInt();
		 * 
		 * if(num<=0) { System.out.println("잘못입력했습니다"); }else { for(int i=1; i<=num;
