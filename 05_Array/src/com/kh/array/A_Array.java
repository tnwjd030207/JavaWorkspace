...
public class A_Array {
	 ...
	 * 		ex) int[] a = new int[3];
	 * 		int자료형 값을 담을  있는 저장공간이 3칸 할당된다. (4byte * 3)
	 * 		[0, 0, 0]
	...
	public void method1( ) {
		...
		arr = new int[5]; //할당 완료  크기 5짜리가 할당한다. -> 초기화
		int [] arr3 = new int[5];
		...
		System.out.println(arr3); //참조형 변수 : 주소 값을 참조
	...
	public void method5( ) {
		...
		// 배열은 한 번 지정한 크기를 변경할 수 없다
		// 배열의 범위를 넘어선 값들을 저장하고자 한다면, 새로운 배열을 생성해야한다
		
		arr = new int[6];
		arr[5] = 12;  // 기존 0~4번 인덱스의 값은 0으로 돌아감
}
	
	
	public void method6() {
		//배열의 선언, 할당, 초기화를 한 번에 수행하는 방법
