...
public class B_ArrayCopy {
	/*
	 * 배열복사
	 * - 얕은 복사 : 배열의 '주소값만'을 복사 (특징 : 공유)
	 * - 깊은 복사 : 동일한 새로운 배열을 하나 생성하여 내부의 값들까지 복사하는 개념 
	 * 
	 */
	...
	public void method3() {
		...
		//  자바 API
		//System.arraycopy (원본배열, 원본배열의 복사를 시작할 인데스, 복사본 배열,
	...
	public void method5() {
		//4. clone메서드를 사용한 복사 (똑같이 쓸 때 사용)
		int [] origin = {1,2,3,4,5};
		
		int [] copy = origin.clone(); //인덱스 지정, 복사할 갯수 지정X
