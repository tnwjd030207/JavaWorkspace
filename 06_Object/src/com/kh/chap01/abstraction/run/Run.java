...
public class Run {
	public static void main(String[] args) {
		 ...
		 * 4. 구현하고자하는 프로그램상의 필요한 객체를 만들기 위해선 클래스라는 틀을 먼저 만들어야 한다
		 * 		-> 클래스는 각 객체들의 속성들을 담아낼 수 있는 설계도의 역할을 하며,
		 * 			추상화와 캡슐화를 거쳐 만들어진다
		 * 5. 추상화 & 캡슐화를 하는 방법
		 * - 내가 구현하고자 하는 프로그램의 목적에 맞는 객체를 선정 후 
		 * 	 그 객체들이 가지고 있을 핵심적인 역할의 속성과 기능만 남긴다
		 */
