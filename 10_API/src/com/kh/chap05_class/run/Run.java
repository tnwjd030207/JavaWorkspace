...
public class Run {
	...
	/*
	 * Class클래스를 활용한 대표적인 프로그래밍 : reflection 프로그래밍
	 * Class클래스를 이용하여 클래스의 정보를 가져오고, 생성자나 메서드를 활용하여 객체를 생성하고,
	 * 메소드를 호출하는 방식의 프로그래밍
	 * 
	 * 보통 프로그래밍이 실행 중일때, 객체의 타입을 직접 알 수 없는 경우 Class를 통해 객체를 생성하고,
	 * 객체 내부의 메타데이터를 수집하기위해 사용한다
	 * 
	...
	public static void main(String[] args) throws ClassNotFoundException, InstantiationException,IllegalAccessException {
		 ...
		 * 	- Class클래스는 이 Class자체의 정보를 가져올 때 사용한다
		 */
