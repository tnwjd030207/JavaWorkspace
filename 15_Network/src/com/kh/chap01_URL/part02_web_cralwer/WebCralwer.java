...
public class WebCralwer {
	...
	public void test1() {
		String address = "https://khedu.co.kr/project/teamView.kh?no=3393&cpage=51";
		...
		try {
			...
			BufferedReader reder = new BufferedReader(new InputStreamReader(conn.getInputStream()) );
			
			//읽어온 데이터 저장할 StringBuilder
	...
	private void saveFile(List<String> imgList) {
		// imgList의 길이만큼 반복하여, URL객체를 생성하고
		
		String imgPath = "/resources/images/team1.jpg";
