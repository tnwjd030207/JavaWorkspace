package com.kh.chap3_protocol.udp.server;
...
public class ServerRun {
	/*
	 * UDP
	 * 	- 비열결형프로토콜로 크라이언트가 데이터를 받았는지 아닌지 상관하지 않는 방식의 프로토콜
...
public static void main(String[] args) {
	...
	try {
		...
		socket.receive(packet);
			...
			System.out.println(" clinetAddress :"+ clinetAddress.getHostAddress()+":"+packet.getPort());
